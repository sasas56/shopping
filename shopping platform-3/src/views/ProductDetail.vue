...
import { getProductPromotion } from '../utils/promotion'
import { useCartStore } from '../stores/cart'
import { useUserStore } from '../stores/user'
import { useWishlistStore } from '../stores/wishlist'
import type { Product, ProductPromotion, Review } from '../types'
...
const promotionInfo = ref<ProductPromotion | null>(null)
...
async function loadProduct() {
  ...
  promotionInfo.value = getProductPromotion(productData.id, productData.price)
        ...
        <div class="bg-white rounded-lg shadow-sm overflow-hidden">
          <div class="flex flex-col lg:flex-row">
            ...
            <div class="lg:w-1/2 p-8">
              ...
              <PromotionTag v-if="promotionInfo" :promotion="promotionInfo" />
              <CountDown v-if="promotionInfo" :promotion="promotionInfo" />
